...
import { guidesApi, type Guide } from "@/lib/services/other.service";
          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center">
                <div className="w-16 h-16 bg-gradient-to-br from-green-500 to-blue-600 rounded-full flex items-center justify-center text-white font-bold text-xl mr-3">
                  {guide.name.charAt(0)}
                </div>
                <div>
            ...
            <div className="space-y-2 mb-4">
              ...
              <div className="flex flex-wrap gap-1 mt-2">
                {guide.languages.map((lang, index) => (
                  <span
                    key={index}
                    className="px-2 py-1 text-xs font-semibold rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-400"
                  >
                    {lang}
                  </span>
                ))}
